...
export default function MapVehicles({ vehicles }: TableProps) {
    ...
    return (
        <section className="bg-[#031621] p-4 rounded-lg h-[500px]">
            <h2 className="mb-4 text-lg font-medium">Mapa rastreador</h2>
            {
                ...
                >
                    ...
                    {selectedVehicle && (
                        ...
                        >
                            <div className="bg-[#001722] rounded-md shadow-lg px-4 py-2 text-white text-sm text-center min-w-[160px]">
